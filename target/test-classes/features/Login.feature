...
#  If test step is has yellow background, that means it doesn't have implementation yet
#  click command /ctr + option/alt + L to organize code, save like in java
#  I have somewhere from 2 to 25 scenarios in every feature file
#  By passing parameters/strings in "some words" we can reuse test steps
